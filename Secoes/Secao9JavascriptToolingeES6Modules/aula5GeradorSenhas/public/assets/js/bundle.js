...
function gerarSenha(tamanho, _ref) {
  ...
  while (i < tamanho) {
    ...
    if (maiuscula === 1) {
      senha.push((0,_geradores__WEBPACK_IMPORTED_MODULE_0__.geraMaiuscula)());
      i++;
    }
    if (minuscula === 1) {
      senha.push((0,_geradores__WEBPACK_IMPORTED_MODULE_0__.geraMinuscula)());
      i++;
    }
    if (numero === 1) {
      senha.push((0,_geradores__WEBPACK_IMPORTED_MODULE_0__.geraNumero)());
      i++;
    }
  }
  senha = senha.join('');
...
/* harmony export */   geraNumero: () => (/* binding */ geraNumero)
/* harmony export */ });
...
function obterTamanho() {
  var tamanhoEntrada = document.querySelector('.tamanhoEntrada');
  var tamanho = Number(tamanhoEntrada.value);
  return tamanho;
}
function adicionar() {
  var maiusculas = document.querySelector('.chk-maiusculas');
  var minusculas = document.querySelector('.chk-minusculas');
...
function saida(gerarSenha) {
  var div = document.querySelector('.senha-gerada');
  var novaSenha = gerarSenha;
  div.innerHTML = "".concat(novaSenha);
}
function executar() {
  obterTamanho();
  if (typeof obterTamanho() !== 'undefined') adicionar();
  if (typeof adicionar() !== 'undefined') {
    var senhaGerada = (0,_modules_FormGeraSenha__WEBPACK_IMPORTED_MODULE_1__.gerarSenha)(obterTamanho(), adicionar());
    saida(senhaGerada);
  }
}
